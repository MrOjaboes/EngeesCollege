...
namespace EngeesCollege.Controllers
{
    public class OfficeAssignmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InstructorID,Location,Address")] OfficeAssignment officeAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InstructorID,Location,Address")] OfficeAssignment officeAssignment)
        {
            if (ModelState.IsValid)
            {
